...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet2 | P2P_s2-spine1_Ethernet8 | - | 10.255.1.157/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_s2-spine2_Ethernet8 | - | 10.255.1.159/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_s2-core1_Ethernet3 | - | 172.16.255.132/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_s2-core2_Ethernet3 | - | 172.16.255.134/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.1.0.104/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.1.1.102/32 |
...
router bgp 65199
   ...
   neighbor 10.1.0.110 description s2-spine1_Loopback0
   neighbor 10.1.0.112 peer group EVPN-OVERLAY-LOCAL-PEERS
   neighbor 10.1.0.112 remote-as 65100
   neighbor 10.1.0.112 description s2-spine2_Loopback0
   ...
   neighbor 192.1.1.202 description s2-brdr1_Vlan4093
   ...
   vrf A
      ...
      neighbor 192.2.2.202 description s2-brdr1_Vlan4001
