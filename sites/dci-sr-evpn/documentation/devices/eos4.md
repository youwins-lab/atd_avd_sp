...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet3 | P2P_eos5_Ethernet1 | - | 10.4.5.4/24 | default | 9214 | False | - | - |
| Ethernet4 | P2P_eos2_Ethernet2 | - | 10.2.4.4/24 | default | 9214 | False | - | - |
| Ethernet5 | P2P_eos3_Ethernet5 | - | 10.102.0.25/31 | default | 9214 | False | - | - |

##### ISIS

| Interface | Channel Group | ISIS Instance | ISIS BFD | ISIS Metric | Mode | ISIS Circuit Type | Hello Padding | ISIS Authentication Mode |
| --------- | ------------- | ------------- | -------- | ----------- | ---- | ----------------- | ------------- | ------------------------ |
| Ethernet3 | - | CORE | - | 10 | point-to-point | level-2 | - | - |
...
!
interface Ethernet3
   description P2P_eos5_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet4
   description P2P_eos2_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description P2P_eos3_Ethernet5
   no shutdown
   mtu 9214
   no switchport
   ip address 10.102.0.25/31
```
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.1921.6825.5013.00 |
| Type | level-2 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.102.0.24 | 65220 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.255.12 | 65220 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 16 | 192.168.255.13:10016 | 10016:10016<br>remote 10016:10016 | - | - | learned |
| 17 | 192.168.255.13:10017 | 10017:10017<br>remote 10017:10017 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| tenant-a | 192.168.255.13:1000 | connected | - |
...
router bgp 1
   ...
   neighbor 10.102.0.24 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.102.0.24 remote-as 65220
   neighbor 10.102.0.24 description eos3_Ethernet5
   neighbor 192.168.255.12 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.12 remote-as 65220
   neighbor 192.168.255.12 description eos3_Loopback0
   ...
   vlan 16
      ...
      rd evpn domain remote 192.168.255.13:10016
   ...
   vlan 17
      ...
      rd evpn domain remote 192.168.255.13:10017
