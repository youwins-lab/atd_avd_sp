...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_eos3_Ethernet3 | - | 10.2.3.2/24 | default | 9214 | False | - | - |
| Ethernet2 | P2P_eos4_Ethernet4 | - | 10.2.4.2/24 | default | 9214 | False | - | - |
| Ethernet3 | P2P_eos5_Ethernet3 | - | 10.2.5.2/24 | default | 9214 | False | - | - |
| Ethernet4 | P2P_eos6_Ethernet5 | - | 10.2.6.2/24 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_eos3_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet4
   description P2P_eos6_Ethernet5
   no shutdown
   mtu 9214
   no switchport
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0020.0200.2002.00 |
| Type | level-2 |
| Router-ID | 2.2.2.2 |
...
| 5.5.5.5 | Inherited from peer group RR-OVERLAY-PEERS | default | - | Inherited from peer group RR-OVERLAY-PEERS | Inherited from peer group RR-OVERLAY-PEERS | - | Inherited from peer group RR-OVERLAY-PEERS | - | - | - | - |
...
router bgp 65000
   ...
   neighbor 5.5.5.5 peer group RR-OVERLAY-PEERS
