...
| Ethernet2 | P2P_eos7_Ethernet3 | - | 10.1.7.1/24 | default | 9214 | False | - | - |
| Ethernet3 | CUST1_eos11 | - | 10.1.11.1/24 | CUST1 | 9214 | False | - | - |
| Ethernet4 | P2P_eos6_Ethernet4 | - | 10.1.6.1/24 | default | 9214 | False | - | - |
...
!
interface Ethernet2
   description P2P_eos7_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0010.0100.1001.00 |
| Type | level-2 |
| Router-ID | 1.1.1.1 |
...
| 10.1.11.11 | 65011 | CUST1 | - | - | 0 (no limit) | - | - | - | - | - | - |
...
| -------- | ------------------- | ----------------- | ----------------- | ---------- | --- | ---------- | -------- | --------- |
| SP | 1.1.1.1:500 | 500:500 | False | False | 9214 | CUST3-ELINE | 317 | 316 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| CUST1 | 1.1.1.1:101 | connected | - |
...
router bgp 65000
   ...
   vpws SP
      rd 1.1.1.1:500
      route-target import export evpn 500:500
      mtu 9214
      !
      pseudowire CUST3-ELINE
         evpn vpws id local 317 remote 316
   !
   address-family evpn
   ...
   vrf CUST1
      ...
      router-id 1.1.1.1
      update wait-install
      neighbor 10.1.11.11 remote-as 65011
      neighbor 10.1.11.11 description eos11
      neighbor 10.1.11.11 maximum-routes 0
...
| ---------- | ------- | ---------------- | -------------------- | ---------------- | -------------------- |
| CUST3-ELINE | True | Interface | Ethernet6 | Pseudowire | bgp vpws SP pseudowire CUST3-ELINE |
...
patch panel
   patch CUST3-ELINE
      ...
      !
      connector 2 pseudowire bgp vpws SP pseudowire CUST3-ELINE
   !
```
