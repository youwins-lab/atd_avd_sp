...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | CUST2_eos14 | *access | *100 | *- | *- | 4 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_eos4_Ethernet2 | - | 10.4.8.8/24 | default | 9214 | False | - | - |
| Ethernet2 | CUST1_eos15 | - | 10.8.15.8/24 | CUST1 | 9214 | False | - | - |
| Ethernet3 | P2P_eos6_Ethernet2 | - | 10.6.8.8/24 | default | 9214 | False | - | - |
| Ethernet5 | CUST4_eos18 | - | 10.8.18.8/24 | CUST4 | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_eos4_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet3
   description P2P_eos6_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | ROUTER_eos14 | access | 100 | - | - | - | - | - | 0000:0000:0375:406d:88c1 |
...
| --------- | --------------------------- | --------------------------- | ------------ |
| Port-Channel4 | 0000:0000:0375:406d:88c1 | all-active | 03:75:40:6d:88:c1 |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 8.8.8.8/32 |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0080.0800.8008.00 |
| Type | level-2 |
| Router-ID | 8.8.8.8 |
...
| 10.8.15.15 | 65015 | CUST1 | - | - | 0 (no limit) | - | - | - | - | - | - |
| 10.8.18.18 | 65018 | CUST4 | - | - | 0 (no limit) | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 8.8.8.8:10100 | 10100:10100 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| CUST1 | 8.8.8.8:101 | connected | - |
| CUST4 | 8.8.8.8:104 | connected | - |
...
router bgp 65000
   ...
   vrf CUST1
      ...
      route-target export vpn-ipv4 101:101
      router-id 8.8.8.8
      update wait-install
      neighbor 10.8.15.15 remote-as 65015
      neighbor 10.8.15.15 description eos15
      neighbor 10.8.15.15 maximum-routes 0
   ...
   vrf CUST4
      ...
      route-target import vpn-ipv4 199:199
      route-target export vpn-ipv4 104:104
      router-id 8.8.8.8
      update wait-install
      neighbor 10.8.18.18 remote-as 65018
      neighbor 10.8.18.18 description eos18
      neighbor 10.8.18.18 maximum-routes 0
      redistribute connected
      !
      address-family ipv4
