...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet6 | CUST2_eos14 | *access | *100 | *- | *- | 4 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_eos5_Ethernet5 | - | 10.5.6.6/24 | default | 9214 | False | - | - |
| Ethernet2 | P2P_eos8_Ethernet3 | - | 10.6.8.6/24 | default | 9214 | False | - | - |
| Ethernet3 | CUST1_eos13 | - | 10.6.13.6/24 | CUST1 | 9214 | False | - | - |
| Ethernet4 | P2P_eos1_Ethernet4 | - | 10.1.6.6/24 | default | 9214 | False | - | - |
| Ethernet5 | P2P_eos2_Ethernet4 | - | 10.2.6.6/24 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_eos5_Ethernet5
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description P2P_eos2_Ethernet4
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 6.6.6.6/32 |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0060.0600.6006.00 |
| Type | level-2 |
| Router-ID | 6.6.6.6 |
...
| 10.6.13.13 | 65013 | CUST1 | - | - | 0 (no limit) | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 6.6.6.6:10100 | 10100:10100 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| CUST1 | 6.6.6.6:101 | connected | - |
...
router bgp 65000
   ...
   vrf CUST1
      ...
      router-id 6.6.6.6
      update wait-install
      neighbor 10.6.13.13 remote-as 65013
      neighbor 10.6.13.13 description eos13
      neighbor 10.6.13.13 maximum-routes 0
