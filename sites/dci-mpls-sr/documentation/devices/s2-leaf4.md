...
| --------- | --------------- | ------------ | --------- |
| LeafPair2 | Vlan4094 | 10.102.252.46 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_s2-leaf3_Ethernet1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet4 | SERVER_s2-host2_Ethernet2 | *trunk | *16-17 | *- | *- | 4 |
| Ethernet6 | MLAG_s2-leaf3_Ethernet6 | *trunk | *- | *- | *MLAG | 1000 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet2 | P2P_s2-spine1_Ethernet5 | - | 10.102.0.97/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_s2-spine2_Ethernet5 | - | 10.102.0.99/31 | default | 9214 | False | - | - |
...
interface Ethernet3
   ...
   mtu 9214
   no switchport
   ip address 10.102.0.99/31
!
interface Ethernet4
   description SERVER_s2-host2_Ethernet2
   no shutdown
...
| Port-Channel1000 | MLAG_s2-leaf3_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_s2-leaf3_Port-Channel1000
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.255.25/32 |
...
| Vlan3016 | tenant-a | 10.255.16.47/31 | - | - | - | - |
| Vlan4093 | default | 10.102.254.47/31 | - | - | - | - |
| Vlan4094 | default | 10.102.252.47/31 | - | - | - | - |
...
interface Vlan3016
   ...
   mtu 9214
   vrf tenant-a
   ip address 10.255.16.47/31
!
interface Vlan4093
   description MLAG_L3
   no shutdown
   mtu 9214
   ip address 10.102.254.47/31
!
interface Vlan4094
   description MLAG
   no shutdown
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.102.0.96 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.102.0.98 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.102.254.46 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.255.16.46 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | tenant-a | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 16 | 192.168.255.25:10016 | 10016:10016 | - | - | learned |
| 17 | 192.168.255.25:10017 | 10017:10017 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| tenant-a | 192.168.255.25:16 | connected | - |
...
router bgp 65102
   ...
   neighbor 10.102.0.96 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.102.0.96 remote-as 65100
   neighbor 10.102.0.96 description s2-spine1_Ethernet5
   neighbor 10.102.0.98 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.102.0.98 remote-as 65100
   neighbor 10.102.0.98 description s2-spine2_Ethernet5
   neighbor 10.102.254.46 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 10.102.254.46 description s2-leaf3_Vlan4093
   ...
   !
   vlan 16
      rd 192.168.255.25:10016
      route-target both 10016:10016
      redistribute learned
   !
   vlan 17
      rd 192.168.255.25:10017
   ...
   !
   vrf tenant-a
      rd 192.168.255.25:16
      route-target import evpn 16:16
      route-target export evpn 16:16
      router-id 192.168.255.25
      update wait-install
      neighbor 10.255.16.46 peer group MLAG-IPV4-UNDERLAY-PEER
      neighbor 10.255.16.46 description s2-leaf3_Vlan3016
