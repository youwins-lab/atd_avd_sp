...
| --------- | --------------- | ------------ | --------- |
| LeafPair1 | Vlan4094 | 10.102.252.42 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_s2-leaf1_Ethernet1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet4 | SERVER_s2-host1_Ethernet2 | *trunk | *16-17 | *- | *- | 4 |
| Ethernet6 | MLAG_s2-leaf1_Ethernet6 | *trunk | *- | *- | *MLAG | 1000 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet2 | P2P_s2-spine1_Ethernet3 | - | 10.102.0.89/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_s2-spine2_Ethernet3 | - | 10.102.0.91/31 | default | 9214 | False | - | - |
...
interface Ethernet3
   ...
   mtu 9214
   no switchport
   ip address 10.102.0.91/31
!
interface Ethernet4
   description SERVER_s2-host1_Ethernet2
   no shutdown
...
| Port-Channel1000 | MLAG_s2-leaf1_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_s2-leaf1_Port-Channel1000
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.255.23/32 |
...
| Vlan3016 | tenant-a | 10.255.16.43/31 | - | - | - | - |
| Vlan4093 | default | 10.102.254.43/31 | - | - | - | - |
| Vlan4094 | default | 10.102.252.43/31 | - | - | - | - |
...
interface Vlan3016
   ...
   mtu 9214
   vrf tenant-a
   ip address 10.255.16.43/31
!
interface Vlan4093
   description MLAG_L3
   no shutdown
   mtu 9214
   ip address 10.102.254.43/31
!
interface Vlan4094
   description MLAG
   no shutdown
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.102.0.88 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.102.0.90 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.102.254.42 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.255.16.42 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | tenant-a | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 16 | 192.168.255.23:10016 | 10016:10016 | - | - | learned |
| 17 | 192.168.255.23:10017 | 10017:10017 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| tenant-a | 192.168.255.23:16 | connected | - |
...
router bgp 65101
   ...
   neighbor 10.102.0.88 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.102.0.88 remote-as 65100
   neighbor 10.102.0.88 description s2-spine1_Ethernet3
   neighbor 10.102.0.90 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.102.0.90 remote-as 65100
   neighbor 10.102.0.90 description s2-spine2_Ethernet3
   neighbor 10.102.254.42 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 10.102.254.42 description s2-leaf1_Vlan4093
   ...
   !
   vlan 16
      rd 192.168.255.23:10016
      route-target both 10016:10016
      redistribute learned
   !
   vlan 17
      rd 192.168.255.23:10017
   ...
   !
   vrf tenant-a
      rd 192.168.255.23:16
      route-target import evpn 16:16
      route-target export evpn 16:16
      router-id 192.168.255.23
      update wait-install
      neighbor 10.255.16.42 peer group MLAG-IPV4-UNDERLAY-PEER
      neighbor 10.255.16.42 description s2-leaf1_Vlan3016
