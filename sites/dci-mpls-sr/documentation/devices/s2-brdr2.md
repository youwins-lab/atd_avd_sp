...
| --------- | --------------- | ------------ | --------- |
| BrdrLeafs | Vlan4094 | 10.102.253.142 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_s2-brdr1_Ethernet1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet6 | MLAG_s2-brdr1_Ethernet6 | *trunk | *- | *- | *MLAG | 1000 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet2 | P2P_s2-spine1_Ethernet8 | - | 10.102.3.33/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_s2-spine2_Ethernet8 | - | 10.102.3.35/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_s2-core1_Ethernet3 | - | 172.16.2.4/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_s2-core2_Ethernet3 | - | 172.16.2.6/31 | default | 9214 | False | - | - |
...
interface Ethernet3
   ...
   mtu 9214
   no switchport
   ip address 10.102.3.35/31
!
interface Ethernet4
   description P2P_s2-core1_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel1000 | MLAG_s2-brdr1_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_s2-brdr1_Port-Channel1000
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.255.201/32 |
...
| Vlan3016 | tenant-a | 10.255.17.143/31 | - | - | - | - |
| Vlan4093 | default | 10.102.255.143/31 | - | - | - | - |
| Vlan4094 | default | 10.102.253.143/31 | - | - | - | - |
...
interface Vlan3016
   ...
   mtu 9214
   vrf tenant-a
   ip address 10.255.17.143/31
!
interface Vlan4093
   description MLAG_L3
   no shutdown
   mtu 9214
   ip address 10.102.255.143/31
!
interface Vlan4094
   description MLAG
   no shutdown
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.102.3.32 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.102.3.34 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.102.255.142 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.16.2.5 | 1 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.2.7 | 1 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.17.142 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | tenant-a | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 16 | 192.168.255.201:10016 | 10016:10016<br>remote 10016:10016 | - | - | learned |
| 17 | 192.168.255.201:10017 | 10017:10017<br>remote 10017:10017 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| tenant-a | 192.168.255.201:16 | connected | - |
...
router bgp 65199
   ...
   neighbor 10.102.3.32 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.102.3.32 remote-as 65100
   neighbor 10.102.3.32 description s2-spine1_Ethernet8
   neighbor 10.102.3.34 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.102.3.34 remote-as 65100
   neighbor 10.102.3.34 description s2-spine2_Ethernet8
   neighbor 10.102.255.142 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 10.102.255.142 description s2-brdr1_Vlan4093
   neighbor 172.16.2.5 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.16.2.5 remote-as 1
   neighbor 172.16.2.5 description s2-core1_Ethernet3
   neighbor 172.16.2.7 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.16.2.7 remote-as 1
   neighbor 172.16.2.7 description s2-core2_Ethernet3
   ...
   !
   vlan 16
      rd 192.168.255.201:10016
      rd evpn domain remote 192.168.255.201:10016
      route-target both 10016:10016
      route-target import export evpn domain remote 10016:10016
      redistribute learned
   !
   vlan 17
      rd 192.168.255.201:10017
      rd evpn domain remote 192.168.255.201:10017
   ...
   !
   vrf tenant-a
      rd 192.168.255.201:16
      route-target import evpn 16:16
      route-target export evpn 16:16
      router-id 192.168.255.201
      update wait-install
      neighbor 10.255.17.142 peer group MLAG-IPV4-UNDERLAY-PEER
      neighbor 10.255.17.142 description s2-brdr1_Vlan3016
