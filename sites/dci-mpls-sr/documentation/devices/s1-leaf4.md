...
| --------- | --------------- | ------------ | --------- |
| LeafPair2 | Vlan4094 | 10.101.252.26 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_s1-leaf3_Ethernet1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet4 | SERVER_s1-host2_Ethernet2 | *trunk | *16-17 | *- | *- | 4 |
| Ethernet6 | MLAG_s1-leaf3_Ethernet6 | *trunk | *- | *- | *MLAG | 1000 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet2 | P2P_s1-spine1_Ethernet5 | - | 10.101.0.57/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_s1-spine2_Ethernet5 | - | 10.101.0.59/31 | default | 9214 | False | - | - |
...
interface Ethernet3
   ...
   mtu 9214
   no switchport
   ip address 10.101.0.59/31
!
interface Ethernet4
   description SERVER_s1-host2_Ethernet2
   no shutdown
...
| Port-Channel1000 | MLAG_s1-leaf3_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_s1-leaf3_Port-Channel1000
   no shutdown
   switchport mode trunk
...
| Vlan3016 | tenant-a | 10.255.16.27/31 | - | - | - | - |
| Vlan4093 | default | 10.101.254.27/31 | - | - | - | - |
| Vlan4094 | default | 10.101.252.27/31 | - | - | - | - |
...
interface Vlan3016
   ...
   mtu 9214
   vrf tenant-a
   ip address 10.255.16.27/31
!
interface Vlan4093
   description MLAG_L3
   no shutdown
   mtu 9214
   ip address 10.101.254.27/31
!
interface Vlan4094
   description MLAG
   no shutdown
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.101.0.56 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.101.0.58 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.101.254.26 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.255.16.26 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | tenant-a | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 16 | 192.168.255.15:10016 | 10016:10016 | - | - | learned |
| 17 | 192.168.255.15:10017 | 10017:10017 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| tenant-a | 192.168.255.15:16 | connected | - |
...
router bgp 65002
   ...
   neighbor 10.101.0.56 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.101.0.56 remote-as 65000
   neighbor 10.101.0.56 description s1-spine1_Ethernet5
   neighbor 10.101.0.58 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.101.0.58 remote-as 65000
   neighbor 10.101.0.58 description s1-spine2_Ethernet5
   neighbor 10.101.254.26 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 10.101.254.26 description s1-leaf3_Vlan4093
   ...
   !
   vlan 16
      rd 192.168.255.15:10016
      route-target both 10016:10016
      redistribute learned
   !
   vlan 17
      rd 192.168.255.15:10017
   ...
   !
   vrf tenant-a
      rd 192.168.255.15:16
      route-target import evpn 16:16
      route-target export evpn 16:16
      router-id 192.168.255.15
      update wait-install
      neighbor 10.255.16.26 peer group MLAG-IPV4-UNDERLAY-PEER
      neighbor 10.255.16.26 description s1-leaf3_Vlan3016
